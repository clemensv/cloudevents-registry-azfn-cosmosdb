...
namespace Azure.CloudEvents.Discovery
{
    public class DiscoveryService
    {
        ...
        public async Task<HttpResponseData> Services(
            [HttpTrigger(AuthorizationLevel.User|AuthorizationLevel.Function|AuthorizationLevel.System, "get", "post", "delete", "options", Route = "services")]
            HttpRequestData req,
            ILogger log)
        {
        ...
        public async Task<HttpResponseData> Service(
            [HttpTrigger(AuthorizationLevel.User|AuthorizationLevel.Function|AuthorizationLevel.System, "get", "post", "put", "delete", "options", Route = "services/{id}")]
            HttpRequestData req,
            string id,
            ILogger log)
        {
